...
public interface ICompraService
{
    ...
    Task<List<CompraResponse>> GetMisComprasAsync(string emailUsuario, CancellationToken cancellationToken = default);
    Task<CompraResponse?> GetByIdAsync(int idCompra, string emailUsuario, CancellationToken cancellationToken = default);
    Task<List<EntradaResponse>> GetMisEntradasAsync(string emailUsuario, CancellationToken cancellationToken = default);
