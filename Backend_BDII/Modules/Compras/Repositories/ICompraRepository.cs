...
public interface ICompraRepository
{
    ...
    Task<List<CompraResponse>> GetByUsuarioAsync(string emailUsuario, CancellationToken cancellationToken = default);
    Task<CompraResponse?> GetByIdAsync(int idCompra, string emailUsuario, CancellationToken cancellationToken = default);
    Task<List<EntradaResponse>> GetEntradasAsignadasAsync(string emailUsuario, CancellationToken cancellationToken = default);
