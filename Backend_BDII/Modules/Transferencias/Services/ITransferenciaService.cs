...
public interface ITransferenciaService
{
    ...
    Task<List<TransferenciaResponse>> GetMisTransferenciasAsync(string emailUsuario, string? relacion, string? estado, CancellationToken cancellationToken = default);
